...
import { Eye, Phone, Star, CheckCircle, MapPin, Clock } from "lucide-react"
  ...
  const benefits = [
    {
      ...
      description: "Equipamentos modernos para avaliação ocular completa",
    },
    {
    ...
    {
      title: "Oftalmologistas Experientes",
