      ...
      <header className="bg-white shadow-sm border-b py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <Button className="bg-[#008b47] hover:bg-[#2ea55c] text-white font-bold text-base md:text-lg">
              <a
                href="https://wa.me/557530268494"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 md:py-3"
              >
                <svg
      ...
      <section className="relative bg-gradient-to-r from-[#008b47] to-[#2ea55c] text-white py-20 px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-2xl text-left md:text-left">
            ...
            <div>
              <Button asChild className="w-full bg-[#a3d65c] text-white font-extrabold text-sm md:text-3xl rounded-xl px-4 py-4 md:py-8 text-center">
